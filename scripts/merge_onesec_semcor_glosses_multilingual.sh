...
data/training_data/babelnet_multilingual_glosses/glosses_es.parsed.filter.data.xml \
...
data/training_data/babelnet_multilingual_glosses/glosses_fr.parsed.filter.data.xml \
...
data/training_data/babelnet_multilingual_glosses/glosses_it.parsed.filter.data.xml \
data/training_data/onesec/it/onesec.it.new_testset_instances.data.xml \
--lang it \
--dataset_name onesec_it+semcor_it+babelgloss_it \
--outpath data/training_data/onesec_multilingual+semcor_multilingual+glosses_multilingual/onesec_it+semcor_it+babelgloss_it.filter.data.xml